...
var References = function (_React$Component) {
    ...
    function References(props) {
        ...
        _this.dataUrl = document.getElementById('references-widget').getAttribute('data-url');
        _this.splitData = document.getElementById('references-widget').getAttribute('data-split');
    ...
    _createClass(References, [{
        ...
        value: function componentDidMount() {
            if (this.splitData == "true") {
                this.fetchReferences(4);
            } else {
                this.fetchReferencesLoadAll();
            }
        }
    }, {
        key: 'fetchReferencesLoadAll',
        value: function fetchReferencesLoadAll() {
            var _this2 = this;
        ...
        key: 'fetchReferences',
        value: function fetchReferences(limit) {
            var _this3 = this;

            this.setState({ showLoading: true });
            _axios2.default.get(this.dataUrl + "&offset=" + this.state.offset + "&limit=" + limit).then(function (response) {
                var offset = _this3.state.offset;
                if (response.data.has_more) {
                    offset += limit;
                }
                _this3.setState({
                    items: [].concat(_toConsumableArray(_this3.state.items), _toConsumableArray(response.data.items)),
                    total: response.data.total_items,
                    offset: offset,
        ...
        value: function loadMore() {
            this.fetchReferences(this.state.limit);
        }
    }, {
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                ...
                this.state.total > 0 && _react2.default.createElement(
                    ...
                    this.state.split && this.state.hasMore ? _react2.default.createElement(
                        'button',
                        { className: 'button button-load-more', onClick: this.loadMore.bind(this) },
                        'Load more'
                    ) : ""
                )
            );
...
(0, _reactDom.render)(_react2.default.createElement(References, null), document.getElementById('references-widget'));
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                this.props.items.map(function (object, i) {
                    return _react2.default.createElement(_Item2.default, { key: i, doi: object.doi,
                        published_date: object.published_date,
                        issue: object.issue,
                        volume: object.volume,
                        journal: object.journal,
                        page_from: object.page_from,
                        page_to: object.page_to,
            ...
            return _react2.default.createElement(
                ...
                !this.props.ssrn_id ? _react2.default.createElement(
                    ...
                    this.props.authors ? _react2.default.createElement(
                        ...
                        this.props.authors.length > 10 ? _react2.default.createElement(
                            'a',
                    ...
                    this.props.authors ? _react2.default.createElement(
                        ...
                        this.props.authors.slice(0, 10).map(function (object, i) {
                            return _react2.default.createElement(
                                'a',
                                { target: '_blank', key: i, href: object.author_url },
                                object.author_name,
                                _this2.props.authors.length !== i + 1 && _react2.default.createElement(
                                    'span',
                                    null,
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'date-informations' },
                    this.props.ssrn_id ? _react2.default.createElement(
                        _react2.default.Fragment,
                        null,
                        this.props.reference_info ? _react2.default.createElement(
                            'div',
                            null,
                            this.props.reference_info
                        ) : "",
                        this.props.pages ? _react2.default.createElement(
                            'span',
                            null,
                            this.props.pages,
                            ' Pages'
                        ) : "",
                        this.props.posted ? _react2.default.createElement(
                            'span',
                            null,
                            " · Posted: " + this.props.posted
                        ) : "",
                        this.props.revised ? _react2.default.createElement(
                            'span',
                            null,
                            " · Last revised: " + this.props.revised
                        ) : ""
                    ) : _react2.default.createElement(
                        _react2.default.Fragment,
                        null,
                        this.props.journal ? _react2.default.createElement(
                            'span',
                            null,
                            this.props.journal
                        ) : "",
                        this.props.volume ? _react2.default.createElement(
                            'span',
                            null,
                            ", volume " + this.props.volume
                        ) : "",
                        this.props.issue ? _react2.default.createElement(
                            'span',
                            null,
                            ", issue " + this.props.issue
                        ) : "",
                        this.props.page_from ? _react2.default.createElement(
                            'span',
                            null,
                            ", p. " + this.props.page_from
                        ) : "",
                        this.props.page_to ? _react2.default.createElement(
                            'span',
                            null,
                            " - " + this.props.page_to
                        ) : "",
                        this.props.published_date ? _react2.default.createElement(
                            'div',
                            null,
                            "Posted: " + this.props.published_date
                        ) : ""
                    )
                ),
                this.props.ssrn_id && _react2.default.createElement(
                    'div',
                    { className: 'cross-ref-content desktop-only' },
                ...
                this.props.ssrn_id && _react2.default.createElement(
                    'div',
                    { className: 'col-xs-12 cross-ref-content mobile-only' },
                    _react2.default.createElement('span', { className: 'cross-ref-space' }),
                    this.props.is_fee && _react2.default.createElement(
                        'a',
                        { className: 'button-add-to-cart', onClick: this.addToCart.bind(this) },
                ...
                !this.props.ssrn_id && this.props.doi ? _react2.default.createElement(
                    'a',
                    { href: this.props.doi, target: '_blank', className: 'button-crossref' },
                    'Crossref'
                ) : ""
            );
        }
