...
function GetBaseUrl() {
    var widgetRootElement = document.getElementById('mendeley-data-widget'),
        baseUrl = '';

    if (widgetRootElement !== null && widgetRootElement.getAttribute('data-mendeley-url') !== null) {
        baseUrl = widgetRootElement.getAttribute('data-mendeley-url');
    }

    return baseUrl;
}

var assetPath = exports.assetPath = "react/mendeley/";
...
module.exports = __webpack_require__.p + "8589fbb4e51ed65d83b49a7a853c0c20.svg";
...
var PopupWindow = function () {
    function PopupWindow(url, callback) {
    ...
    _createClass(PopupWindow, [{
        ...
        value: function showPopup() {
            if (this.popup == null) {
                this.popup = window.open(this.url, '_blank', 'toolbar=no,menubar=no,scrollbars=no,resizable=yes,width=1024,height=768');
                if (this.timer != null) {
                    clearInterval(this.timer);
                }
                this.timer = setInterval(this.checkForPopupClosure.bind(this), 500);
            } else {
                this.popup.focus();
            }
        }
    }, {
        key: 'checkForPopupClosure',
        value: function checkForPopupClosure() {
...
var ArrowButtonLink = function (_React$Component) {
    _inherits(ArrowButtonLink, _React$Component);

    function ArrowButtonLink(props) {
        _classCallCheck(this, ArrowButtonLink);

        return _possibleConstructorReturn(this, (ArrowButtonLink.__proto__ || Object.getPrototypeOf(ArrowButtonLink)).call(this, props));
    }

    _createClass(ArrowButtonLink, [{
        key: "render",
        value: function render() {
            var classes = (0, _bind2.default)('button-link', 'arrowed', this.props.className);
            return _react2.default.createElement(
                "a",
                _extends({ className: classes
                }, 'clickAction' in this.props && { onClick: this.props.clickAction }, 'href' in this.props && { onClick: this.props.href }),
                this.props.text
            );
        }
    }]);

    return ArrowButtonLink;
}(_react2.default.Component);

exports.default = ArrowButtonLink;
...
var _promisePolyfills = __webpack_require__(47);

var _promisePolyfills2 = _interopRequireDefault(_promisePolyfills);

var _reactDom = __webpack_require__(49);

var _DatasetList = __webpack_require__(58);

var _DatasetList2 = _interopRequireDefault(_DatasetList);

var _BaseUrl = __webpack_require__(7);

var _AbstractID = __webpack_require__(67);

var _UploadBox = __webpack_require__(68);
...
var App = function (_Component) {
    ...
    function App(props) {
        ...
        _this.mendeleyUrl = (0, _BaseUrl.GetBaseUrl)() + "mendeley/datasets?abstractId=" + (0, _AbstractID.GetAbstractID)();
        ...
        _this.getMendeleyData = _this.getMendeleyData.bind(_this);
        _this.handlePublishAndRefresh = _this.handlePublishAndRefresh.bind(_this);
        return _this;
    }
    ...
    _createClass(App, [{
        ...
        value: function componentDidMount() {
            this.getMendeleyData();
        }
    }, {
        key: 'handlePublishAndRefresh',
        value: function handlePublishAndRefresh() {
            this.publishMendeleyDataset();
            this.getMendeleyData();
        }
    }, {
        key: 'publishMendeleyDataset',
        value: function publishMendeleyDataset() {
            var _this2 = this;

            _axios2.default.post(this.mendeleyUrl).then(function (response) {
                if (response.status === 204) {
                    _this2.getMendeleyData();
                } else {
        ...
        key: 'getMendeleyData',
        value: function getMendeleyData() {
            var _this3 = this;

            _axios2.default.get(this.mendeleyUrl, { withCredentials: true }).then(function (response) {

                var newDatasets = response.data.datasets.map(function (d) {
                    return {
                        datasetId: d.id,
                        name: d.name,
                        ...
                        url: d.url,
                        editPageUrl: d.editPageUrl,
                        datasetFiles: d.datasetFiles
                    };
                });
                ...
                _this3.setState({
                    ...
                    uploadPageUrl: response.data.uploadPageUrl,
                    linkPageUrl: "",
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                { className: 'App', 'data-processed': this.state.requestComplete },
                _react2.default.createElement(_DatasetList2.default, { datasets: this.state.datasets,
                    isAuthor: this.state.isAuthor,
                    mendeleyUrl: this.mendeleyUrl,
                    getMendeleyData: this.getMendeleyData,
                    handlePublishAndRefresh: this.handlePublishAndRefresh }),
                this.state.isAuthor ? _react2.default.createElement(_UploadBox2.default, { getMendeleyData: this.getMendeleyData,
                    uploadPageUrl: this.state.uploadPageUrl,
                    linkPageUrl: '',
                    handlePublishAndRefresh: this.handlePublishAndRefresh }) : ''
            );
        }
...
(0, _reactDom.render)(_react2.default.createElement(App, null), document.getElementById('mendeley-data-widget'));
...
*/
var aa=__webpack_require__(3),ca=__webpack_require__(0),m=__webpack_require__(17),p=__webpack_require__(5),v=__webpack_require__(4),da=__webpack_require__(18),ea=__webpack_require__(19),fa=__webpack_require__(20),ha=__webpack_require__(6);
...
var _Dataset = __webpack_require__(59);
...
var DatasetList = function (_React$Component) {
    ...
    function DatasetList(props) {
        ...
        return _possibleConstructorReturn(this, (DatasetList.__proto__ || Object.getPrototypeOf(DatasetList)).call(this, props));
    }
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                this.props.datasets.map(function (d) {
                    return _react2.default.createElement(_Dataset2.default, { datasetId: d.datasetId,
                        key: d.name,
                        name: d.name,
                        licenceName: d.licenceName,
                        licenceUrl: d.licenceUrl,
                        description: d.description,
                        fileCount: d.fileCount, url: d.url,
                        editPageUrl: d.editPageUrl,
                        getMendeleyData: _this2.props.getMendeleyData,
                        isAuthor: _this2.props.isAuthor,
                        datasetFiles: d.datasetFiles,
                        mendeleyUrl: _this2.props.mendeleyUrl,
                        handlePublishAndRefresh: _this2.props.handlePublishAndRefresh });
                })
            );
        }
    }]);
...
var _mendeleyLogo = __webpack_require__(21);

var _mendeleyLogo2 = _interopRequireDefault(_mendeleyLogo);

var _BaseUrl = __webpack_require__(7);

var _PopupWindow = __webpack_require__(22);

var _PopupWindow2 = _interopRequireDefault(_PopupWindow);

var _FileWrapper = __webpack_require__(60);

var _FileWrapper2 = _interopRequireDefault(_FileWrapper);

var _UnlinkBox = __webpack_require__(65);

var _UnlinkBox2 = _interopRequireDefault(_UnlinkBox);
...
var Dataset = function (_React$Component) {
    ...
    function Dataset(props) {
        ...
        _this.baseUrl = (0, _BaseUrl.GetBaseUrl)();
        _this.popupWindow = new _PopupWindow2.default(_this.props.editPageUrl, _this.props.handlePublishAndRefresh);

        _this.state = {
            unlinkActive: false
        };

        _this.toggleUnlinkActive = _this.toggleUnlinkActive.bind(_this);
        _this.unlinkMendeleyDataset = _this.unlinkMendeleyDataset.bind(_this);
        return _this;
    }

    _createClass(Dataset, [{
        key: "toggleUnlinkActive",
        value: function toggleUnlinkActive() {
            this.setState({
                unlinkActive: !this.state.unlinkActive
            });
        }
    }, {
        key: "fileBlockContent",
        value: function fileBlockContent() {
            if (this.state.unlinkActive) {
                return _react2.default.createElement(_UnlinkBox2.default, { toggleUnlinkActive: this.toggleUnlinkActive,
                    unlinkMendeleyDataset: this.unlinkMendeleyDataset });
            }

            if (this.props.fileCount > 0) {
                return _react2.default.createElement(_FileWrapper2.default, { isAuthor: this.props.isAuthor,
                    datasetFiles: this.props.datasetFiles,
                    url: this.props.url,
                    fileCount: this.props.fileCount,
                    toggleUnlinkActive: this.toggleUnlinkActive,
                    showPopup: this.popupWindow.showPopup });
            }

            return '';
        }
    }, {
        key: "unlinkMendeleyDataset",
        value: function unlinkMendeleyDataset() {
            var _this2 = this;

            _axios2.default.delete(this.props.mendeleyUrl + "&datasetId=" + this.props.datasetId).then(function (response) {
                if (response.status === 204) {
                    _this2.props.getMendeleyData();
                } else {
        ...
        value: function render() {
            return _react2.default.createElement(
                "div",
                { className: "dataset" },
                _react2.default.createElement("img", { src: this.baseUrl + _BaseUrl.assetPath + _mendeleyLogo2.default, alt: "Mendeley Logo" }),
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        "a",
                        { className: "dataset-licence", target: "_blank",
                            href: this.props.licenceUrl },
                        this.props.licenceName,
                        " ",
                        _react2.default.createElement(
                            "span",
                            null,
                ...
                _react2.default.createElement(
                    ...
                    !this.props.isAuthor ? _react2.default.createElement(
                        "a",
...
var _FileBlock = __webpack_require__(61);
...
var FileWrapper = function (_React$Component) {
    _inherits(FileWrapper, _React$Component);

    function FileWrapper(props) {
        _classCallCheck(this, FileWrapper);

        return _possibleConstructorReturn(this, (FileWrapper.__proto__ || Object.getPrototypeOf(FileWrapper)).call(this, props));
    }

    _createClass(FileWrapper, [{
        key: "fileCountDisplay",
        value: function fileCountDisplay() {
            if (this.props.fileCount > 1) {
                return "all " + this.props.fileCount + " files";
            } else {
                return "this file";
            }
        }
        ...
        value: function render() {
            return _react2.default.createElement(
                "div",
                null,
                _react2.default.createElement(_FileBlock2.default, { isAuthor: this.props.isAuthor,
                    datasetFiles: this.props.datasetFiles,
                    toggleUnlinkActive: this.props.toggleUnlinkActive,
                    showPopup: this.props.showPopup }),
                !this.props.isAuthor ? _react2.default.createElement(
                    "a",
                    { className: "show-all-files", href: this.props.url, target: "_blank" },
                    "Show ",
                    this.fileCountDisplay(),
                    " on Mendeley Data ",
                    _react2.default.createElement(
                        "span",
                        null,
...
var FileBlock = function (_React$Component) {
    _inherits(FileBlock, _React$Component);

    function FileBlock(props) {
        _classCallCheck(this, FileBlock);

        return _possibleConstructorReturn(this, (FileBlock.__proto__ || Object.getPrototypeOf(FileBlock)).call(this, props));
    }
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    this.props.isAuthor ? _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            "a",
                            { className: "edit-research-data", onClick: this.props.showPopup },
                            "Add/Edit Research Data"
                        ),
                        _react2.default.createElement(
                            "a",
                            { className: "unlink-data", onClick: this.props.toggleUnlinkActive },
                            "Unlink"
                        )
                    ) : ''
                ),
                _react2.default.createElement(
                    "div",
                    { className: "file-list" },
                    this.props.datasetFiles.map(function (f) {
                        return _react2.default.createElement(_File2.default, { key: f.filename, name: f.filename, size: f.fileSize, url: f.url });
                    })
                )
            );
        }
...
var _gizmoDownload = __webpack_require__(63);

var _gizmoDownload2 = _interopRequireDefault(_gizmoDownload);

var _gizmoDocFile = __webpack_require__(64);

var _gizmoDocFile2 = _interopRequireDefault(_gizmoDocFile);
...
var File = function (_React$Component) {
    ...
    function File(props) {
        ...
        _this.baseUrl = (0, _BaseUrl.GetBaseUrl)();
        _this.printableFileSize = _this.getPrintableFileSizeWithUnits();
        return _this;
    }

    _createClass(File, [{
        key: "formatUnitSize",
        value: function formatUnitSize(size, divisibleBy, quantifier) {
            return parseFloat(size / divisibleBy).toFixed(1).toString() + quantifier;
        }
    }, {
        key: "getPrintableFileSizeWithUnits",
        value: function getPrintableFileSizeWithUnits() {
            if (this.props.size >= 1073741824) {
                return this.formatUnitSize(this.props.size, 1073741824, "GB");
            }
            if (this.props.size >= 1048576) {
                return this.formatUnitSize(this.props.size, 1048576, "MB");
            }
            if (this.props.size >= 1024) {
                return this.formatUnitSize(this.props.size, 1024, "KB");
            }
            return "1KB";
        }
    }, {
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    "div",
                    null,
                    _react2.default.createElement("img", { src: this.baseUrl + _BaseUrl.assetPath + _gizmoDocFile2.default, alt: "Paper" }),
                    _react2.default.createElement(
                        "span",
                        null,
                        this.props.name
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        "span",
                        null,
                        this.printableFileSize
                    ),
                    _react2.default.createElement(
                        "a",
                        { href: this.props.url },
                        _react2.default.createElement("img", { src: this.baseUrl + _BaseUrl.assetPath + _gizmoDownload2.default, alt: "Download" })
                    )
                )
            );
        }
...
module.exports = __webpack_require__.p + "322849965248ce3cb0d28864989721dc.svg";

/***/ }),
/* 64 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "9535d22e4b3bcfc2f72a849675579533.svg";
...
var _ArrowButtonLink = __webpack_require__(23);

var _ArrowButtonLink2 = _interopRequireDefault(_ArrowButtonLink);

var _ButtonLink = __webpack_require__(66);
...
var UnlinkBox = function (_React$Component) {
    _inherits(UnlinkBox, _React$Component);

    function UnlinkBox(props) {
        _classCallCheck(this, UnlinkBox);

        return _possibleConstructorReturn(this, (UnlinkBox.__proto__ || Object.getPrototypeOf(UnlinkBox)).call(this, props));
    }

    _createClass(UnlinkBox, [{
        key: "render",
        value: function render() {
            return _react2.default.createElement(
                "div",
                { className: "unlink-box" },
                _react2.default.createElement(
                    "p",
                    null,
                    "Are you sure you want to unlink this dataset?"
                ),
                _react2.default.createElement(_ButtonLink2.default, { className: "testing",
                    clickAction: this.props.toggleUnlinkActive,
                    text: "Cancel" }),
                _react2.default.createElement(_ArrowButtonLink2.default, { className: "unlink-button",
                    clickAction: this.props.unlinkMendeleyDataset,
                    text: "Unlink research data" })
            );
        }
    }]);
...
var ButtonLink = function (_React$Component) {
    ...
    _createClass(ButtonLink, [{
        key: "render",
        value: function render() {
            var classes = (0, _bind2.default)('button-link', this.props.className);
            return _react2.default.createElement(
                "a",
                _extends({ className: classes
                }, 'clickAction' in this.props && { onClick: this.props.clickAction }, 'href' in this.props && { onClick: this.props.href }),
...
exports.GetAbstractID = GetAbstractID;
/**
 * @return {string}
 */
function GetAbstractID() {
    ...
    if (widgetRootElement !== null && widgetRootElement.getAttribute('data-abstract-id') !== null) {
        abstractID = widgetRootElement.getAttribute('data-abstract-id');
    }
...
var UploadBox = function (_React$Component) {
    ...
    function UploadBox(props) {
        ...
        var _this = _possibleConstructorReturn(this, (UploadBox.__proto__ || Object.getPrototypeOf(UploadBox)).call(this, props));

        _this.state = {
            addDataActive: false
        };

        _this.toggleDataActive = _this.toggleDataActive.bind(_this);
        _this.baseUrl = (0, _BaseUrl.GetBaseUrl)();

        _this.popupWindowUpload = new _PopupWindow2.default(_this.props.uploadPageUrl, _this.props.handlePublishAndRefresh);
        return _this;
    }

    _createClass(UploadBox, [{
        key: "toggleDataActive",
        value: function toggleDataActive() {
            this.setState({
                addDataActive: !this.state.addDataActive
            });
        }
    }, {
        key: "render",
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            "span",
                            null,
                            "Attention: Once you upload your dataset, it will be sent to Mendeley for publication and will be visible as soon as it has been approved by the "
                        ),
                        _react2.default.createElement(
                            "a",
                            { href: "https://www.mendeley.com/datasets", target: "_blank" },
                            "Mendeley Data"
                        ),
                        _react2.default.createElement(
                            "span",
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            "a",
                            { className: "text-link", href: "https://data.mendeley.com/faq", target: "_blank" },
                            "Learn more"
                        )
                    )
                ),
                _react2.default.createElement(
                    "div",
                    null,
                    _react2.default.createElement(_ArrowButtonLink2.default, { className: "upload-dataset-popup",
                        clickAction: this.popupWindowUpload.showPopup, text: "Upload research data" })
                )
            );
        }
    }]);
