...
gaLoader.sites = ['anthrosource','aapm','agupubs','aasldpubs','aslopubs','bpspubs','esajournals','physoc','iubmb','ascpt','stemcellsjournals'];
gaLoader.accounts = ['3','12','2','4','6','11','7','5','8','9','10'];
gaLoader.load = function(){
	...
	if(siteIndex>=0){
		...
		if(window.ga){
		  ga('create', gaLoader.base + siteIndex, 'auto');
		  gaLoader.trackHubPV();
		} 
