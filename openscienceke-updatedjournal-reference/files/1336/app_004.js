...
var UrlBuilder = function () {
    function UrlBuilder(domains) {
        _classCallCheck(this, UrlBuilder);

        this.assetDomain = domains === null ? document.querySelector("meta[name='static_server']").getAttribute('content') : domains.assetDomain;
        this.webDomain = domains === null ? document.querySelector("meta[name='www_server']").getAttribute('content') : domains.webDomain;
        this.hqDomain = domains === null ? document.querySelector("meta[name='hq_server']").getAttribute('content') : domains.hqDomain;
        this.papersDomain = domains === null ? document.querySelector("meta[name='papers_server']").getAttribute('content') : domains.papersDomain;
    }

    _createClass(UrlBuilder, [{
        key: "protocol",
        value: function protocol(domain) {
            return domain === 'localhost:9090' ? 'http://' : 'https://';
        }
    }, {
        key: "assetPath",
        value: function assetPath() {
            return this.assetDomain === 'localhost:9090' ? '/' : '/cfincludes/global_header/dist/';
        }
    }, {
        key: "buildInternalUrl",
        value: function buildInternalUrl(domain) {
            var path = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';

            switch (domain) {
                case 'www':
                    return this.buildWebUrl(path);
                case 'hq':
                    return this.buildHqUrl(path);
                case 'papers':
                    return this.buildPapersUrl(path);
            }
        }
    }, {
        key: "buildAssetUrl",
        value: function buildAssetUrl(fileName) {
            return this.protocol(this.assetDomain) + this.assetDomain + this.assetPath() + fileName;
        }
    }, {
        key: "buildWebUrl",
        value: function buildWebUrl() {
            var path = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';

            path = '/' + path;
            return this.protocol(this.webDomain) + this.webDomain + path;
        }
    }, {
        key: "buildHqUrl",
        value: function buildHqUrl() {
            var path = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';

            path = '/' + path;
            return this.protocol(this.hqDomain) + this.hqDomain + path;
        }
    }, {
        key: "buildPapersUrl",
        value: function buildPapersUrl() {
            var path = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';

            path = '/' + path;
            return this.protocol(this.papersDomain) + this.papersDomain + path;
        }
    }]);
...
var Menu = function (_React$Component) {
    ...
    function Menu(props) {
        ...
        _this.signalItemFocused = _this.signalItemFocused.bind(_this);
        _this.signalItemBlurred = _this.signalItemBlurred.bind(_this);
        return _this;
    }

    _createClass(Menu, [{
        key: 'signalItemFocused',
        value: function signalItemFocused() {
            this.props.focused();
        }
    }, {
        key: 'signalItemBlurred',
        value: function signalItemBlurred() {
            this.props.blurred();
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            return _react2.default.createElement(
                'ul',
                null,
                this.props.menuObjects.map(function (object, i) {
                    return _react2.default.createElement(_Link2.default, _extends({ item: object, key: i
                    }, 'focused' in _this2.props && { focused: _this2.signalItemFocused }, 'blurred' in _this2.props && { blurred: _this2.signalItemBlurred }, 'hidden' in _this2.props && { hidden: _this2.props.hidden }, {
                        participantId: _this2.props.participantId
                    }));
                })
            );
        }
...
var Profile = function (_React$Component) {
    ...
    _createClass(Profile, [{
        ...
        value: function getUserName() {
            var userNameMeta = document.querySelector("meta[name='user_name']");
            var userName = '';
            if (userNameMeta !== null && userNameMeta.getAttribute('content') !== null) {
                userName = _react2.default.createElement(
                    'span',
                    null,
                    userNameMeta.getAttribute('content')
                );
            }
            return userName;
        }
        ...
        value: function getUserEmail() {
            var userEmailMeta = document.querySelector("meta[name='user_email']");
            var userEmail = '';
            if (userEmailMeta !== null && userEmailMeta.getAttribute('content') !== null) {
                userEmail = _react2.default.createElement(
                    'span',
                    null,
                    userEmailMeta.getAttribute('content')
                );
            }
            return userEmail;
        }
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                { className: 'profile' },
                _react2.default.createElement(_Avatar2.default, { big: true }),
...
var Logo = function (_React$Component) {
    ...
    _createClass(Logo, [{
        ...
        value: function getAvatar() {
            var initialsMeta = document.querySelector("meta[name='user_initials']"),
                avatarMeta = document.querySelector("meta[name='user_avatar']"),
                avatarContent = '';

            if (avatarMeta !== null && avatarMeta.getAttribute('content') !== null) {
                avatarContent = _react2.default.createElement("img", { src: avatarMeta.getAttribute('content') });
            } else if (initialsMeta !== null && initialsMeta.getAttribute('content') !== null) {
                avatarContent = _react2.default.createElement(
                    "span",
                    null,
                    initialsMeta.getAttribute('content')
                );
            } else {
                var userName = document.querySelector("meta[name='user_name']").getAttribute('content');
                var initials = userName.split(" ").map(function (n, i, a) {
        ...
        value: function render() {
            var classes = (0, _bind2.default)({
                avatar: true,
                big: 'big' in this.props && this.props.big
            });
...
var _UrlBuilder = __webpack_require__(2);
...
var AccountButtons = function (_React$Component) {
    _inherits(AccountButtons, _React$Component);

    function AccountButtons(props) {
        _classCallCheck(this, AccountButtons);

        var _this = _possibleConstructorReturn(this, (AccountButtons.__proto__ || Object.getPrototypeOf(AccountButtons)).call(this, props));

        _this.urlBuilder = new _UrlBuilder2.default(_this.props.domains ? _this.props.domains : null);
        return _this;
    }

    _createClass(AccountButtons, [{
        key: 'createSignOutUrl',
        value: function createSignOutUrl() {
            return this.props.idPlusAuthEnabled ? this.props.idPlusLogoutUrl + this.urlBuilder.buildHqUrl('SignOut.cfm') : this.urlBuilder.buildHqUrl('SignOut.cfm');
        }
    }, {
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                ...
                !this.props.isCustom ? _react2.default.createElement(
                    'a',
                    { className: 'button-link clear', href: this.urlBuilder.buildHqUrl('Participant.cfm?rectype=edit&perinf=y&partid=' + this.props.participantId) },
                    'View account'
                ) : '',
                _react2.default.createElement(
                    'a',
                    { className: 'button-link', href: this.createSignOutUrl() },
                    'Sign out'
                )
            );
        }
...
exports.default = AccountButtons;
...
var _IdPlusAuthButtons = __webpack_require__(39);

var _IdPlusAuthButtons2 = _interopRequireDefault(_IdPlusAuthButtons);

var _SsrnAuthButtons = __webpack_require__(40);

var _SsrnAuthButtons2 = _interopRequireDefault(_SsrnAuthButtons);
...
var AuthButtons = function (_React$Component) {
    _inherits(AuthButtons, _React$Component);

    function AuthButtons(props) {
        _classCallCheck(this, AuthButtons);

        return _possibleConstructorReturn(this, (AuthButtons.__proto__ || Object.getPrototypeOf(AuthButtons)).call(this, props));
    }

    _createClass(AuthButtons, [{
        key: "render",
        value: function render() {
            return _react2.default.createElement(
                _react2.default.Fragment,
                null,
                this.props.idPlusAuthEnabled ? _react2.default.createElement(_IdPlusAuthButtons2.default, null) : _react2.default.createElement(_SsrnAuthButtons2.default, null)
            );
        }
    }]);
...
var _UserMenu = __webpack_require__(37);
...
var _AuthButtons = __webpack_require__(19);

var _AuthButtons2 = _interopRequireDefault(_AuthButtons);
...
var _user_menu = __webpack_require__(48);

var _user_menu2 = _interopRequireDefault(_user_menu);

var _Hamburger = __webpack_require__(49);

var _Hamburger2 = _interopRequireDefault(_Hamburger);

var _MainContent = __webpack_require__(51);
...
var GlobalHeader = function (_React$Component) {
    ...
    function GlobalHeader(props) {
        ...
        _this.toggleSearchOpen = _this.toggleSearchOpen.bind(_this);
        _this.toggleUserMenuOpen = _this.toggleUserMenuOpen.bind(_this);
        _this.toggleMobileMenuOpen = _this.toggleMobileMenuOpen.bind(_this);

        _this.participantId = document.querySelector("meta[name='part_id']").getAttribute('content');

        _this.idPlusAuthEnabled = document.getElementById('global-header').getAttribute("data-id-plus-auth-enabled").toLowerCase() === "true";
        if (_this.idPlusAuthEnabled) {
            _this.idPlusLogoutUrl = document.querySelector('meta[name="id_plus_logout_url"]').getAttribute("content");
        }
        return _this;
    }

    _createClass(GlobalHeader, [{
        key: 'toggleSearchOpen',
        value: function toggleSearchOpen() {
            this.setState({
                searchOpen: !this.state.searchOpen
            });
        }
    }, {
        key: 'toggleUserMenuOpen',
        value: function toggleUserMenuOpen() {
            this.setState({
                userMenuOpen: !this.state.userMenuOpen
            });
        }
    }, {
        key: 'toggleMobileMenuOpen',
        value: function toggleMobileMenuOpen() {
            this.setState({
        ...
        value: function isUserAuthenticated() {
            var partId = document.querySelector("meta[name='part_id']");
            var authenticated = false;
            if (partId !== null && partId.getAttribute('content') !== '1') {
                authenticated = true;
            }
        ...
        key: 'isLiteHeader',
        value: function isLiteHeader() {
            return document.querySelector("meta[name='is_custom']").getAttribute('content') === 'true';
        }
    }, {
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                'div',
                { className: 'wrapper' },
                _react2.default.createElement(_Logo2.default, { isLiteHeader: this.isLiteHeader() }),
                _react2.default.createElement(_MobileMenu2.default, { active: this.state.mobileMenuOpen, toggleMobileMenuOpen: this.toggleMobileMenuOpen,
                    authenticated: this.isUserAuthenticated(), isLiteHeader: this.isLiteHeader(),
                    MenuList: _menu2.default, UserMenuList: _user_menu2.default, idPlusAuthEnabled: this.idPlusAuthEnabled,
                    idPlusLogoutUrl: this.idPlusLogoutUrl,
                    participantId: this.participantId }),
                _react2.default.createElement(
                    'div',
                    null,
                    !this.isLiteHeader() ? _react2.default.createElement(_MainContent2.default, { MenuList: _menu2.default, searchOpen: this.state.searchOpen,
                        toggleSearchOpen: this.toggleSearchOpen, participantId: this.participantId,
                        authenticated: this.isUserAuthenticated() }) : '',
                    _react2.default.createElement(_Hamburger2.default, { toggleMobileMenuOpen: this.toggleMobileMenuOpen }),
                    this.isUserAuthenticated() ? _react2.default.createElement(
                        'div',
                        { className: 'user-menu' },
                        _react2.default.createElement(
                            'button',
                            { className: 'user-button', onClick: this.toggleUserMenuOpen },
                            _react2.default.createElement(_Avatar2.default, null)
                        ),
                        _react2.default.createElement(_UserMenu2.default, { active: this.state.userMenuOpen,
                            isCustom: this.isLiteHeader(),
                            UserMenuList: _user_menu2.default,
                            idPlusAuthEnabled: this.idPlusAuthEnabled,
                            idPlusLogoutUrl: this.idPlusLogoutUrl,
                            participantId: this.participantId })
                    ) : _react2.default.createElement(
                        'nav',
                        { className: 'auth-menu' },
                        _react2.default.createElement(_AuthButtons2.default, { idPlusAuthEnabled: this.idPlusAuthEnabled })
                    )
                )
            );
        }
...
(0, _reactDom.render)(_react2.default.createElement(GlobalHeader, null), document.getElementById('global-header'));
...
*/
var aa=__webpack_require__(3),ca=__webpack_require__(0),m=__webpack_require__(12),p=__webpack_require__(7),v=__webpack_require__(4),da=__webpack_require__(13),ea=__webpack_require__(14),fa=__webpack_require__(15),ha=__webpack_require__(8);
...
var _ssrnLogo = __webpack_require__(33);

var _ssrnLogo2 = _interopRequireDefault(_ssrnLogo);

var _poweredByBOW = __webpack_require__(34);

var _poweredByBOW2 = _interopRequireDefault(_poweredByBOW);

var _elsevierLogo = __webpack_require__(35);

var _elsevierLogo2 = _interopRequireDefault(_elsevierLogo);

var _ssrnWordmark = __webpack_require__(36);

var _ssrnWordmark2 = _interopRequireDefault(_ssrnWordmark);
...
var Logo = function (_React$Component) {
    ...
    function Logo(props) {
        ...
        _this.originalLogo = true;
        _this.urlBuilder = new _UrlBuilder2.default(_this.props.domains ? _this.props.domains : null);
        _this.logo = _this.props.isLiteHeader ? _poweredByBOW2.default : _this.urlBuilder.buildAssetUrl(_ssrnLogo2.default);
        return _this;
    }
    ...
    _createClass(Logo, [{
        ...
        value: function render() {
            var classes = (0, _bind2.default)({
                logo: true,
                original: this.originalLogo,
                'powered-by': this.props.isLiteHeader
            });

            return _react2.default.createElement(
                'div',
                { className: classes },
                this.originalLogo ? _react2.default.createElement(
                    'div',
                    null,
                    _react2.default.createElement(
                        'a',
                        { href: this.urlBuilder.buildWebUrl() },
                        _react2.default.createElement('img', { src: this.logo })
                    )
                ) : _react2.default.createElement(
                    'div',
                    null,
                    _react2.default.createElement('img', { src: this.urlBuilder.buildAssetUrl(_elsevierLogo2.default) }),
                    _react2.default.createElement('img', { src: this.urlBuilder.buildAssetUrl(_ssrnWordmark2.default) })
                )
            );
        }
    }]);
...
module.exports = __webpack_require__.p + "d41510e5ae62bd5d798e36e0bdc649ca.svg";

/***/ }),
/* 34 */
/***/ (function(module, exports) {

module.exports = "data:image/png;base64,"

/***/ }),
/* 35 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "71f45043180bbcba664a6cefa3b80897.svg";

/***/ }),
/* 36 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "f30ac35ccfcb4ad559a177381f5afd00.svg";
...
var _AccountButtons = __webpack_require__(18);

var _AccountButtons2 = _interopRequireDefault(_AccountButtons);
...
var UserMenu = function (_React$Component) {
    ...
    _createClass(UserMenu, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                { className: 'dropdown-box', 'data-active': this.props.active },
                _react2.default.createElement(
                    'div',
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'nav',
                            null,
                            !this.props.isCustom ? _react2.default.createElement(_Menu2.default, { menuObjects: this.props.UserMenuList, hidden: !this.props.active,
                                participantId: this.props.participantId }) : '',
                            _react2.default.createElement(_AccountButtons2.default, { isCustom: this.props.isCustom,
                                idPlusAuthEnabled: this.props.idPlusAuthEnabled,
                                idPlusLogoutUrl: this.props.idPlusLogoutUrl,
                                participantId: this.props.participantId })
                        )
                    )
                )
...
var Link = function (_React$Component) {
    ...
    function Link(props) {
        ...
        _this.handleChildBlur = _this.handleChildBlur.bind(_this);

        _this.isExternal = 'external' in _this.props.item && _this.props.item.external;

        var participantString = _this.getParticipantString();
        var impersonationString = _this.getImpersonationString(participantString);
        _this.linkUrl = _this.generateLinkUrl(participantString, impersonationString);
        return _this;
    }
    ...
    _createClass(Link, [{
        ...
        key: 'getParticipantString',
        value: function getParticipantString() {
            return this.props.item.participantIdRequired ? "partid=" + this.props.participantId : "";
        }
    }, {
        key: 'getImpersonationString',
        value: function getImpersonationString(participantString) {
            var impersonationString = "";

            var browsingOnBehalf = this.props.browsingOnBehalf !== undefined ? this.props.browsingOnBehalf : document.querySelector("meta[name='on_behalf']").getAttribute('content') === 'true';

            if (this.props.item.href && participantString !== "" && this.props.item.impersonation && browsingOnBehalf) {
                var loginUserId = this.props.loginUserId !== undefined ? this.props.loginUserId : document.querySelector("meta[name='login_user_id']").getAttribute('content');
                impersonationString += "&participant=" + loginUserId;
            }

            return impersonationString;
        }
    }, {
        key: 'generateLinkUrl',
        value: function generateLinkUrl(participantString, impersonationString) {
            return this.isExternal ? this.props.item.href : this.urlBuilder.buildInternalUrl(this.props.item.server, this.props.item.href + participantString + impersonationString);
        }
    }, {
        key: 'render',
        value: function render() {
            var listClass = (0, _bind2.default)({
                dropdown: 'children' in this.props.item
            });

            var linkClass = (0, _bind2.default)({
                external: this.isExternal
            });

            return _react2.default.createElement(
                'li',
                _extends({ className: listClass
                }, this.state.childActive && { "data-active": this.state.childActive.toString() }),
                _react2.default.createElement(
                    'a',
                    _extends({
                        className: linkClass,
                        ...
                        tabIndex: 'hidden' in this.props && this.props.hidden ? '-1' : '0'
                    }, 'href' in this.props.item && { href: this.linkUrl }),
                    this.props.item.text,
                    this.isExternal ? _react2.default.createElement(
                        'span',
                        { className: 'external' },
                        '\u2197'
                    ) : ''
                ),
                'children' in this.props.item ? _react2.default.createElement(
                    'div',
                    { className: 'dropdown-box' },
                    _react2.default.createElement(
                        'div',
                        { className: 'dropdown-wrap' },
                        _react2.default.createElement(_Menu2.default, { menuObjects: this.props.item.children, focused: this.handleChildFocus,
                            blurred: this.handleChildBlur, participantId: this.props.participantId })
                    )
                ) : ''
            );
        }
...
var IdPlusAuthButtons = function (_React$Component) {
    _inherits(IdPlusAuthButtons, _React$Component);

    function IdPlusAuthButtons(props) {
        _classCallCheck(this, IdPlusAuthButtons);

        var _this = _possibleConstructorReturn(this, (IdPlusAuthButtons.__proto__ || Object.getPrototypeOf(IdPlusAuthButtons)).call(this, props));

        var meta_id_plus_client_id = document.querySelector("meta[name='id_plus_client_id']");
        var meta_id_plus_plat_site = document.querySelector("meta[name='id_plus_plat_site']");
        var meta_id_plus_endpoint = document.querySelector("meta[name='id_plus_endpoint']");
        var meta_id_plus_redirect_url = document.querySelector("meta[name='id_plus_redirect_url']");

        _this.idPlusClientId = meta_id_plus_client_id != null ? meta_id_plus_client_id.getAttribute('content') : '';
        _this.idPlusPlatSite = meta_id_plus_plat_site != null ? meta_id_plus_plat_site.getAttribute('content') : '';
        _this.idPlusEndpoint = meta_id_plus_endpoint != null ? meta_id_plus_endpoint.getAttribute('content') : '';
        _this.idPlusRedirectUrl = meta_id_plus_redirect_url != null ? meta_id_plus_redirect_url.getAttribute('content') : '';
        return _this;
    }

    _createClass(IdPlusAuthButtons, [{
        key: "render",
        value: function render() {
            return _react2.default.createElement(
                _react2.default.Fragment,
                ...
                _react2.default.createElement(
                    "form",
                    { action: this.idPlusEndpoint, method: "POST", encType: "application/x-www-form-urlencoded" },
                    _react2.default.createElement("input", { type: "hidden", name: "client_id", value: this.idPlusClientId }),
                    _react2.default.createElement("input", { type: "hidden", name: "platSite", value: this.idPlusPlatSite }),
                    _react2.default.createElement("input", { type: "hidden", name: "prompt", value: "login" }),
                    _react2.default.createElement("input", { type: "hidden", name: "redirect_uri", value: this.idPlusRedirectUrl }),
                    _react2.default.createElement("input", { type: "hidden", name: "response_type", value: "code" }),
                    _react2.default.createElement("input", { type: "hidden", name: "scope", value: "openid profile email" }),
                    _react2.default.createElement(
                        "button",
                        { className: "button-link clear", type: "submit" },
                        "Create account"
                    ),
                    _react2.default.createElement(
                        "button",
                        { className: "button-link", type: "submit" },
                        "Sign In"
                    )
                )
            );
    ...
    return IdPlusAuthButtons;
}(_react2.default.Component);

exports.default = IdPlusAuthButtons;
...
var SsrnAuthButtons = function (_React$Component) {
    _inherits(SsrnAuthButtons, _React$Component);

    function SsrnAuthButtons(props) {
        _classCallCheck(this, SsrnAuthButtons);

        var _this = _possibleConstructorReturn(this, (SsrnAuthButtons.__proto__ || Object.getPrototypeOf(SsrnAuthButtons)).call(this, props));

        _this.urlBuilder = new _UrlBuilder2.default(_this.props.domains ? _this.props.domains : null);
        _this.useAlternateRegisterUrl = _this.props.alternate !== undefined ? _this.props.alternate : document.querySelector("meta[name='own_design']").getAttribute('content') === 'true';
        _this.abId = _this.props.abId ? _this.props.abId : document.querySelector("meta[name='ab_id']").getAttribute('content');
        _this.registerUrl = _this.urlBuilder.buildHqUrl('login/pubsigninjoin.cfm');
        _this.alternateRegisterUrl = _this.urlBuilder.buildPapersUrl('sol3/Data_Integrity_Notice.cfm?abid=' + _this.abId);
        return _this;
    }

    _createClass(SsrnAuthButtons, [{
        key: 'createRegisterUrl',
        value: function createRegisterUrl() {
            return this.useAlternateRegisterUrl ? this.alternateRegisterUrl : this.registerUrl;
        }
    }, {
        key: 'createSignInUrl',
        value: function createSignInUrl() {
            return this.useAlternateRegisterUrl ? this.registerUrl + "?abid=" + this.abId : this.registerUrl;
        }
    }, {
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'a',
                    { className: 'button-link clear', href: this.createRegisterUrl() },
                    'Create account'
                ),
                _react2.default.createElement(
                    'a',
                    { className: 'button-link', href: this.createSignInUrl() },
                    'Sign in'
                )
            );
        }
    ...
    return SsrnAuthButtons;
}(_react2.default.Component);

exports.default = SsrnAuthButtons;
...
var _hamburgerClose = __webpack_require__(42);

var _hamburgerClose2 = _interopRequireDefault(_hamburgerClose);

var _UrlBuilder = __webpack_require__(2);

var _UrlBuilder2 = _interopRequireDefault(_UrlBuilder);

var _ProfileSection = __webpack_require__(43);

var _ProfileSection2 = _interopRequireDefault(_ProfileSection);

var _MobileMenuList = __webpack_require__(44);

var _MobileMenuList2 = _interopRequireDefault(_MobileMenuList);
...
var MobileMenu = function (_React$Component) {
    ...
    _createClass(MobileMenu, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                { className: 'mobile-menu', 'data-active': this.props.active },
                _react2.default.createElement(
                    'div',
                    null,
                    _react2.default.createElement(
                        'button',
                        { className: 'close', 'aria-label': 'Menu', onClick: this.props.toggleMobileMenuOpen },
                        _react2.default.createElement('img', { src: this.urlBuilder.buildAssetUrl(_hamburgerClose2.default) })
                    ),
                    _react2.default.createElement(_ProfileSection2.default, { authenticated: this.props.authenticated, isLiteHeader: this.props.isLiteHeader,
                        idPlusAuthEnabled: this.props.idPlusAuthEnabled,
                        idPlusLogoutUrl: this.props.idPlusLogoutUrl,
                        participantId: this.props.participantId }),
                    !this.props.isLiteHeader ? _react2.default.createElement(_MobileMenuList2.default, { MenuList: this.props.MenuList, authenticated: this.props.authenticated,
...
module.exports = __webpack_require__.p + "bffc88d9a5d45a42e2eb082f6c04d025.svg";
...
var ProfileSection = function (_React$Component) {
    _inherits(ProfileSection, _React$Component);

    function ProfileSection(props) {
        _classCallCheck(this, ProfileSection);

        return _possibleConstructorReturn(this, (ProfileSection.__proto__ || Object.getPrototypeOf(ProfileSection)).call(this, props));
    }
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                this.props.authenticated ? _react2.default.createElement(
                    ...
                    null,
                    _react2.default.createElement(_Profile2.default, null),
                    _react2.default.createElement(_AccountButtons2.default, { isLiteHeader: this.props.isLiteHeader,
                        idPlusAuthEnabled: this.props.idPlusAuthEnabled,
                        idPlusLogoutUrl: this.props.idPlusLogoutUrl,
                        participantId: this.props.participantId })
                ) : _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        "nav",
                        { className: "auth-menu" },
                        _react2.default.createElement(_AuthButtons2.default, { idPlusAuthEnabled: this.props.idPlusAuthEnabled })
                    )
                )
            );
        }
...
var _MobileUserMenu = __webpack_require__(45);

var _MobileUserMenu2 = _interopRequireDefault(_MobileUserMenu);
...
var MobileMenuList = function (_React$Component) {
    _inherits(MobileMenuList, _React$Component);

    function MobileMenuList(props) {
        _classCallCheck(this, MobileMenuList);

        return _possibleConstructorReturn(this, (MobileMenuList.__proto__ || Object.getPrototypeOf(MobileMenuList)).call(this, props));
    }

    _createClass(MobileMenuList, [{
        key: "render",
        value: function render() {
            return _react2.default.createElement(
                "nav",
                null,
                _react2.default.createElement(_Menu2.default, { menuObjects: this.props.MenuList, participantId: this.props.participantId }),
                this.props.authenticated ? _react2.default.createElement(_MobileUserMenu2.default, { UserMenuList: this.props.UserMenuList, participantId: this.props.participantId }) : ''
            );
        }
    }]);
...
exports.default = MobileMenuList;
...
var MobileUserMenu = function (_React$Component) {
    _inherits(MobileUserMenu, _React$Component);

    function MobileUserMenu(props) {
        _classCallCheck(this, MobileUserMenu);

        return _possibleConstructorReturn(this, (MobileUserMenu.__proto__ || Object.getPrototypeOf(MobileUserMenu)).call(this, props));
    }

    _createClass(MobileUserMenu, [{
        key: "render",
        value: function render() {
            return _react2.default.createElement(
                "div",
                ...
                _react2.default.createElement(_Menu2.default, { menuObjects: this.props.UserMenuList, participantId: this.props.participantId })
            );
        }
    }]);
...
exports.default = MobileUserMenu;
...
module.exports = [{"text":"Browse","href":"sol3/DisplayJournalBrowse.cfm","server":"papers"},{"text":"Subscriptions","href":"index.cfm/en/subscribe/","server":"www"},{"text":"Rankings","children":[{"text":"Top Papers","href":"rankings/Ranking_display.cfm?TRN_gID=10","server":"hq"},{"text":"Top Authors","href":"index.cfm/en/top-authors/","server":"www"},{"text":"Top Organizations","href":"index.cfm/en/top-organizations/","server":"www"}]},{"text":"Submit a paper","href":"submissions/CreateNewAbstract.cfm","server":"hq"},{"text":"My Library","href":"Library/myLibrary.cfm","server":"hq"},{"text":"Blog","href":"http://ssrnblog.com","external":true}]

/***/ }),
/* 48 */
/***/ (function(module, exports) {

module.exports = [{"text":"User Home","href":"UserHome.cfm","server":"hq","participantIdRequired":false},{"text":"Affiliations","href":"Affiliations/AffiliationList.cfm?","server":"hq","participantIdRequired":true},{"text":"My Papers","href":"submissions/MyPapers.cfm?","server":"hq","participantIdRequired":true},{"text":"Subscriptions","href":"Subscriptions.cfm?","server":"hq","participantIdRequired":true},{"text":"My Library","href":"Library/myLibrary.cfm?","server":"hq","participantIdRequired":true,"impersonation":true}]
...
var Hamburger = function (_React$Component) {
    ...
    _createClass(Hamburger, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'button',
                { className: 'hamburger', 'aria-label': 'Menu', onClick: this.props.toggleMobileMenuOpen },
                _react2.default.createElement('img', { src: this.urlBuilder.buildAssetUrl(_hamburger2.default) })
            );
        }
    }]);
...
module.exports = __webpack_require__.p + "c62c68008eda7e1eee15910e3d780b8d.svg";
...
var _Utilities = __webpack_require__(52);

var _Utilities2 = _interopRequireDefault(_Utilities);

var _SearchBox = __webpack_require__(53);
    ...
    _createClass(MainContent, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_Utilities2.default, { searchOpen: this.props.searchOpen, toggleSearchOpen: this.props.toggleSearchOpen,
                    authenticated: this.props.authenticated }),
                _react2.default.createElement(_SearchBox2.default, { searchOpen: this.props.searchOpen, toggleSearchOpen: this.props.toggleSearchOpen,
                    authenticated: this.props.authenticated })
            );
        }
    }]);
...
var Utilities = function (_React$Component) {
    ...
    _createClass(Utilities, [{
        ...
        value: function componentWillReceiveProps(nextProps) {
            if (this.props.searchOpen !== nextProps.searchOpen && !nextProps.searchOpen) {
                _reactDom2.default.findDOMNode(this.refs.searchButton).focus();
            }
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'button',
                    { onClick: this.props.toggleSearchOpen, ref: 'searchButton',
                        'aria-label': 'Open search box' },
                    _react2.default.createElement('i', { className: 'icon icon-gizmo-search' })
                ),
                _react2.default.createElement(
                    'a',
                    { className: 'cart-button link-button', 'aria-label': 'Open shopping cart',
                        href: this.urlBuilder.buildPapersUrl("sol3/ShoppingCart.cfm") },
                    _react2.default.createElement('i', { className: 'icon icon-gizmo-shopping-cart' })
                )
            );
        }
    }]);
...
var SearchBox = function (_React$Component) {
    ...
    _createClass(SearchBox, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: classes, 'data-active': this.props.searchOpen },
                _react2.default.createElement(
                    'form',
                    { className: 'search-input-wrapper', action: this.urlBuilder.buildPapersUrl('sol3/results.cfm'), method: 'POST' },
                    _react2.default.createElement('input', { type: 'text', name: 'txtKey_Words', ref: 'searchBox', onKeyDown: this.handleEscKey,
                        'aria-label': 'Search box', tabIndex: this.props.searchOpen ? '0' : '-1' }),
                    _react2.default.createElement('input', { type: 'hidden', name: 'isQuickSearch', value: 'true' }),
                    _react2.default.createElement(
                        'button',
                        { type: 'Submit', 'aria-label': 'Submit', tabIndex: this.props.searchOpen ? '0' : '-1' },
                        _react2.default.createElement('i', { className: 'icon icon-gizmo-search' })
                    )
                ),
                _react2.default.createElement(
                    'button',
                    { className: 'close-button', onClick: this.props.toggleSearchOpen, 'aria-label': 'Close search box',
                        tabIndex: this.props.searchOpen ? '0' : '-1' },
                    _react2.default.createElement('i', { className: 'icon icon-gizmo-delete' })
                )
            );
        }
    }]);
