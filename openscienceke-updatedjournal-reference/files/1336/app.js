...
var _promisePolyfills = __webpack_require__(42);

var _promisePolyfills2 = _interopRequireDefault(_promisePolyfills);

var _reactDom = __webpack_require__(44);

__webpack_require__(53);

var _ItemList = __webpack_require__(54);

var _ItemList2 = _interopRequireDefault(_ItemList);

var _loadingWheel = __webpack_require__(57);

var _loadingWheel2 = _interopRequireDefault(_loadingWheel);
...
var CitationsAbstract = function (_React$Component) {
	_inherits(CitationsAbstract, _React$Component);

	function CitationsAbstract(props) {
		_classCallCheck(this, CitationsAbstract);

		var _this = _possibleConstructorReturn(this, (CitationsAbstract.__proto__ || Object.getPrototypeOf(CitationsAbstract)).call(this, props));

		_this.dataUrl = document.getElementById('citations-widget-abstract').getAttribute('data-url');
		_this.dataUrlCitations = document.getElementById('citations-widget-abstract').getAttribute('data-url-citations');
		return _this;
	}

	_createClass(CitationsAbstract, [{
		...
		key: 'fetchCitations',
		value: function fetchCitations() {
			var _this2 = this;

			_axios2.default.get(this.dataUrl).then(function (response) {
				var txt = document.createElement("textarea");
				txt.innerHTML = response.data.info_icon_message;
				_this2.setState({
					itemsSSRN: response.data.itemsSSRN,
					itemsCrossref: response.data.itemsCrossref,
					total_items: response.data.total_items.toLocaleString().replace(".", ","),
					info: txt.value
				}, function () {
					try {
						setTimeout(function () {
		...
		value: function render() {
			return _react2.default.createElement(
				...
				!this.state && _react2.default.createElement(
					...
					_react2.default.createElement('img', { src: _loadingWheel2.default }),
				...
				this.state && (this.state.itemsCrossref || this.state.itemsSSRN) && (this.state.itemsCrossref.length > 0 || this.state.itemsSSRN.length > 0) && _react2.default.createElement(
					'div',
					{ className: 'this-citations' },
					_react2.default.createElement(_ItemList2.default, { citationsURL: this.dataUrlCitations, itemsSSRN: this.state.itemsSSRN, itemsCrossref: this.state.itemsCrossref, total_items: this.state.total_items }),
					this.state.info && _react2.default.createElement('div', { className: 'cite-reader-tooltip-content hidden', dangerouslySetInnerHTML: { __html: this.state.info } })
				)
			);
		}
	}]);

	return CitationsAbstract;
}(_react2.default.Component);

exports.default = CitationsAbstract;


(0, _reactDom.render)(_react2.default.createElement(CitationsAbstract, null), document.getElementById('citations-widget-abstract'));
...
/* WEBPACK VAR INJECTION */(function(global) {var require;var require;(function e(t, n, r) {
  function s(o, u) {
    if (!n[o]) {
      if (!t[o]) {
...
*/
var aa=__webpack_require__(3),ca=__webpack_require__(2),m=__webpack_require__(15),p=__webpack_require__(5),v=__webpack_require__(4),da=__webpack_require__(16),ea=__webpack_require__(17),fa=__webpack_require__(18),ha=__webpack_require__(6);
...
var ItemList = function (_React$Component) {
	...
	_createClass(ItemList, [{
		...
		value: function render() {
			return _react2.default.createElement(
				'div',
				{ className: this.state.isToggleOn ? 'total-citations-closed' : 'total-citations-openned' },
				_react2.default.createElement(
					'a',
					{ onClick: this.handleClick, title: 'Total Citations', className: 'total-citations-button' },
					_react2.default.createElement(
						'span',
						{ className: 'number-total-citations' },
					...
					_react2.default.createElement(
						'span',
						{ className: 'info-icon' },
						_react2.default.createElement('i', { className: 'icon icon-gizmo-information cite-reader-info', 'data-toggle': 'tooltip' })
					),
					_react2.default.createElement(
						'span',
						null,
						_react2.default.createElement('i', { className: 'icon icon-gizmo-navigate-right', 'aria-hidden': 'true' })
					),
					_react2.default.createElement(
						'span',
						null,
						_react2.default.createElement('i', { className: 'icon icon-gizmo-navigate-down', 'aria-hidden': 'true' })
					)
				),
				_react2.default.createElement(
					'div',
					{ className: 'ssrn-citations' },
					this.props.itemsSSRN && this.props.itemsSSRN.length > 0 && _react2.default.createElement(
						_react2.default.Fragment,
						null,
						_react2.default.createElement(
							'h4',
						...
						_react2.default.createElement(
							'ul',
							null,
							this.props.itemsSSRN.map(function (object, i) {
								return _react2.default.createElement(_Item2.default, _defineProperty({ key: i, published_date: object.published_date,
									issue: object.issue,
									volume: object.volume,
									journal: object.journal,
									page_from: object.page_from,
									reference_info: object.reference_info,
									is_fee: object.is_fee, doi: object.doi,
									ssrn_id: object.ssrn_abstract_id,
									authors: object.authors, title: object.title,
									url: object.abstract_url,
									pages: object.pdf_pages,
									posted: object.posted_date,
									revised: object.revised_date,
									downloads: object.downloads,
									in_myLibrary: object.in_myLibrary,
									iCost: object.iCost,
									iFileSize: object.iFileSize,
									sCollectionName: object.sCollectionName,
									sFileName: object.sFileName,
									fullTextUrl: object.fullTextUrl
								}, 'is_fee', object.is_fee));
							})
						)
					),
					this.props.itemsCrossref && this.props.itemsCrossref.length > 0 && _react2.default.createElement(
						_react2.default.Fragment,
						null,
						_react2.default.createElement(
							'h4',
						...
						_react2.default.createElement(
							'ul',
							null,
							this.props.itemsCrossref.map(function (object, i) {
								return _react2.default.createElement(_Item2.default, { key: i, published_date: object.published_date,
									issue: object.issue,
									volume: object.volume,
									journal: object.journal,
									page_from: object.page_from,
					...
					_react2.default.createElement(
						'a',
						{ href: this.props.citationsURL, className: 'button-view-more-articles' },
						'View all citations ',
						_react2.default.createElement(
							'span',
							null,
...
var _bind = __webpack_require__(56);
...
var Item = function (_React$Component) {
	...
	function Item(props) {
		...
		_this.state = { in_myLibrary: _this.props.in_myLibrary };
		return _this;
	}
	...
	_createClass(Item, [{
		...
		value: function addToCart() {
			...
			var iCost = this.props.iCost;
			var sCollectionName = this.props.sCollectionName;
			var sfile_name = this.props.sfile_name;
			var iFileSize = this.props.iFileSize;
			var title = this.props.title;
			var ssrn_id = this.props.ssrn_id;
			var strPapersServer = this.props.url.split("/")[2];

			window.AddToCart.setState({ quantity: 1,
				iCost: iCost,
				abstractId: ssrn_id,
				strPapersServer: strPapersServer,
				title: title,
				sCollectionName: sCollectionName,
				sfile_name: sfile_name,
				iFileSize: iFileSize
			});
			window.AddToCart.openModal();
		}
	}, {
		key: 'getInMyLibraryState',
		value: function getInMyLibraryState() {
			var inMyLibrary = false;
			if (typeof this.state.in_myLibrary !== 'undefined') {
				inMyLibrary = this.state.in_myLibrary;
			} else {
				inMyLibrary = this.props.in_myLibrary;
			}
			return inMyLibrary;
		}
	}, {
		key: 'addToLibrary',
		value: function addToLibrary(ev) {
			var server = document.getElementById('references-widget').getAttribute('data-server');
			var auth = document.getElementById('references-widget').getAttribute('data-auth');
			var userId = document.getElementById('references-widget').getAttribute('data-user-id');
			var inMyLibrary = this.getInMyLibraryState();
			window.addToMyLibrary(ev, userId, this.props.ssrn_id, server, auth, inMyLibrary);
			if (inMyLibrary) {
				inMyLibrary = false;
			} else {
				inMyLibrary = true;
			}
			this.setState({ in_myLibrary: inMyLibrary });
		}
	}, {
		key: 'render',
		value: function render() {
			...
			var inMyLibrary = this.getInMyLibraryState();
			var starClass = inMyLibrary ? "glyphicon glyphicon-star" : "glyphicon glyphicon-star-empty";
			var library = inMyLibrary ? "Remove Paper from My Library" : "Add Paper to My Library";
			return _react2.default.createElement(
				'li',
				null,
				_react2.default.createElement(
					'h2',
					{ className: 'title' },
					this.props.ssrn_id ? _react2.default.createElement(
						'a',
						{ href: this.props.url },
						this.props.title
					) : _react2.default.createElement(
				...
				!this.props.ssrn_id ? _react2.default.createElement(
					...
					this.props.authors ? _react2.default.createElement(
						...
						this.props.authors.slice(0, 2).map(function (object, i) {
							return _react2.default.createElement(
								'span',
								{ key: i },
								object.author_name,
								_this2.props.authors.length !== i + 1 && _react2.default.createElement(
									'span',
									null,
									', '
								)
						...
						this.props.authors.length > 2 ? _react2.default.createElement(
							'a',
							{ target: '_blank', href: this.props.doi },
							' View more'
						) : ""
					) : ""
				) : _react2.default.createElement(
					...
					this.props.authors ? _react2.default.createElement(
						'div',
						{ className: 'author-list' },
						this.props.authors.slice(0, 10).map(function (object, i) {
							return _react2.default.createElement(
								'a',
								{ key: i, href: object.author_url },
								object.author_name,
								_this2.props.authors.length !== i + 1 && _react2.default.createElement(
									'span',
									null,
				...
				this.props.reference_info && this.props.ssrn_id ? _react2.default.createElement(
					'div',
					{ className: 'reference-info' },
					this.props.reference_info
				) : "",
				this.props.journal && !this.props.ssrn_id ? _react2.default.createElement(
					'div',
					{ className: 'reference-info' },
					this.props.journal
				) : "",
				this.props.downloads && this.props.ssrn_id ? _react2.default.createElement(
					'div',
					{ className: 'downloads' },
					_react2.default.createElement(
						'span',
				...
				this.props.ssrn_id && _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'cross-ref-content' },
						_react2.default.createElement('span', { className: 'cross-ref-space' }),
						this.props.is_fee && _react2.default.createElement(
							'a',
							{ className: 'button-add-to-cart', onClick: this.addToCart.bind(this) },
							' Add To Cart'
						),
						!this.props.is_fee && _react2.default.createElement(
							'a',
							{ href: this.props.fullTextUrl, className: 'button-pdf' },
							' Download PDF'
						)
					),
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'a',
							{ onClick: this.addToLibrary.bind(this), className: 'button-star' },
							_react2.default.createElement('span', { className: starClass }),
							' ',
							library
						)
					)
				),
				!this.props.ssrn_id && this.props.doi ? _react2.default.createElement(
					'div',
					null,
					_react2.default.createElement(
						'a',
						{ href: this.props.doi, target: '_blank', className: 'button-crossref2' },
						'Crossref'
					)
				) : ""
			);
...
module.exports = "data:image/gif;base64,"
