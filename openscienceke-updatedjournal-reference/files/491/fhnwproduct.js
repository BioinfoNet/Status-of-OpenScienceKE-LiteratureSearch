...
$(document).ready(function(){$(".onchangeGoTo").change(function(e){var sel=this;var targetstr='self';GoTo(sel,targetstr);});changedCountry($("#countryCode").find(":selected"));});
