...
"resource": {
  ...
  "macros":[{
      ...
      "function":"__jsm",
      "vtp_javascript":["template","(function(){var a=",["escape",["macro",1],8,16],".querySelector(\"#vl(freeText0)\");return a?a.value:void 0})();"]
    },{
      "function":"__e"
    },{
      "function":"__u",
      ...
      "vtp_dataLayerVersion":2,
      "vtp_setDefaultValue":false,
      "vtp_name":"gtm.element.dataset.tile"
    },{
      "function":"__u",
      "vtp_component":"HOST"
    },{
  ...
  "tags":[{
      ...
      "vtp_trackType":"TRACK_EVENT",
      "vtp_gaSettings":["macro",5],
      "vtp_eventAction":"Catalogus - Full text click",
      "vtp_eventLabel":["macro",7],
      "vtp_enableUaRlsa":false,
      "vtp_enableUseInternalVersion":false,
      "vtp_enableFirebaseCampaignData":true,
      ...
      "once_per_event":true,
      "vtp_overrideGaSettings":false,
      "vtp_useHashDecorateForm":["macro",2],
      ...
      "vtp_trackType":"TRACK_EVENT",
      "vtp_gaSettings":["macro",5],
      "vtp_eventAction":"MyLibraryTile",
      "vtp_eventLabel":["template",["macro",13]," - ",["macro",8]," - ",["macro",10]],
      "vtp_enableUaRlsa":false,
      "vtp_enableUseInternalVersion":false,
      "vtp_enableFirebaseCampaignData":true,
      "vtp_trackTypeIsEvent":true,
      ...
      "vtp_uniqueTriggerId":"6131390_38",
      "tag_id":19
    },{
      "function":"__lcl",
      "vtp_waitForTags":false,
      "vtp_checkValidation":false,
      "vtp_waitForTagsTimeout":"2000",
      "vtp_uniqueTriggerId":"6131390_39",
      "tag_id":20
    },{
      "function":"__cl",
      "tag_id":21
  ...
  "predicates":[{
      ...
      "function":"_cn",
      "arg0":["macro",4],
      "arg1":"library.wur.nl\/webquery\/mylibrary"
    },{
      "function":"_cn",
      "arg0":["macro",4],
      "arg1":"library.wur.nl\/WebQuery\/gkz-"
    },{
      "function":"_cn",
      "arg0":["macro",6],
      "arg1":"label"
      ...
      "function":"_cn",
      "arg0":["macro",4],
      "arg1":"\/WebQuery\/hydrotheek"
    }],
  "rules":[
    [["if",0],["add",0,9,10,11,12,13,14]],
    [["if",4,5],["add",1]],
    [["if",0,6],["add",2]],
    [["if",7,8,9,10],["add",3]],
    [["if",9,11,12,13],["add",3]],
    ...
    [["if",5,16,17],["add",5]],
    [["if",5,18],["add",6]],
    [["if",0,3],["add",7],["block",0]],
    [["if",0,19],["add",8]],
    [["if",0,1,2],["block",0,2,6]]]
},
"runtime":[
[],[]
]
...
b.vtp_trackType){}else if("TRACK_TRANSACTION"==b.vtp_trackType){}else if("TRACK_TIMING"==b.vtp_trackType){}else if("DECORATE_LINK"==b.vtp_trackType){}else if("DECORATE_FORM"==b.vtp_trackType){n(function(){var a=td(),c=U("gtm.element",1),d=a&&a.getByName&&a.getByName(q),e=Ue(V("gaplugins").Linker,d);if(c&&c.method&&"post"!=c.method.toLowerCase()){for(var g=c.childNodes,h=0;h<g.length;h++)if("google_tag_manager_ua_cookie"==
g[h].className){c.removeChild(g[h]);break}var k=e.decorate(c.action)||c.action;k=k.split("?")[1].split("&");for(var l=0;l<k.length;l++){var m=document.createElement("input");m.type="hidden";m.className="google_tag_manager_ua_cookie";var n=k[l].indexOf("=");0<n&&(m.name=k[l].slice(0,n),m.value=k[l].slice(n+1),c.insertBefore(m,null))}}else c&&c.action&&(c.action=e.decorate(c.action,b.vtp_useHashDecorateForm)||c.action,I(b.vtp_gtmOnSuccess))});}else if("TRACK_DATA"==
...
Z.a.hjtc=["nonGoogleScripts"],function(){(function(a){Z.__hjtc=a;Z.__hjtc.g="hjtc";Z.__hjtc.h=!0;Z.__hjtc.b=0})(function(a){var b=a.vtp_hotjar_site_id;bh("hj",function(){(window.hj.q=window.hj.q||[]).push(arguments)});bh("_hjSettings",{hjid:b,hjsv:5});S("//static.hotjar.com/c/hotjar-"+encodeURIComponent(b)+".js?sv=5",a.vtp_gtmOnSuccess,a.vtp_gtmOnFailure)})}();
